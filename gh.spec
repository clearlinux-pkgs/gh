...
Source0  : https://github.com/cli/cli/archive/v2.20.2/cli-2.20.2.tar.gz
...
%prep
%setup -q -n cli-2.20.2
cd %{_builddir}
tar xf %{_sourcedir}/gh-vendor-2.20.2.tar.xz
cd %{_builddir}/cli-2.20.2
mkdir -p ./
cp -r %{_builddir}/gh-vendor-2.20.2/* %{_builddir}/cli-2.20.2/./
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668542845
