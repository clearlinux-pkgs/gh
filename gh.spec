...
Version  : 2.14.2
Release  : 29
URL      : https://github.com/cli/cli/archive/v2.14.2/cli-2.14.2.tar.gz
Source0  : https://github.com/cli/cli/archive/v2.14.2/cli-2.14.2.tar.gz
Source1  : http://localhost/cgit/projects/gh-vendor/snapshot/gh-vendor-2.14.2.tar.xz
...
%prep
%setup -q -n cli-2.14.2
cd %{_builddir}
tar xf %{_sourcedir}/gh-vendor-2.14.2.tar.xz
cd %{_builddir}/cli-2.14.2
mkdir -p ./
cp -r %{_builddir}/gh-vendor-2.14.2/* %{_builddir}/cli-2.14.2/./
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658769180
...
cp %{_builddir}/gh-vendor-%{version}/vendor/github.com/inconshreveable/mousetrap/LICENSE %{buildroot}/usr/share/package-licenses/gh/9174f93c54ad0022bbb9b445480cfb6b4217226a
...
cp %{_builddir}/gh-vendor-%{version}/vendor/github.com/microcosm-cc/bluemonday/LICENSE.md %{buildroot}/usr/share/package-licenses/gh/b13e410d1c8a43f6ae54d404d1deb61f91cc459e
